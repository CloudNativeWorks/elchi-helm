...
./helm.sh elchi-stack install dev
./helm.sh elchi-stack install prod
./helm.sh elchi-discovery install dev
```
...
3. Make changes to specific chart
...
- **Documentation**: [Official Docs](https://chart.elchi.io)
